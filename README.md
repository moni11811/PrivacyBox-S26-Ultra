...
Runtime dependency notices are listed in [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md). The project owner is **moni11811**, the permanent application ID is `com.moni11811.privacybox`, and project-authored source plus the documented ChatGPT-generated artwork are licensed under GNU AGPL-3.0-or-later. Before the first public release, configure the signing owner and CLA/DCO enforcement.
